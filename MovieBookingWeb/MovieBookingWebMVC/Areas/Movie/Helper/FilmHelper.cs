...
namespace MovieBookingWebMVC.Areas.Movie.Helper
{
 ...
 public static class RatingHelper
    ...
    {
        public static Dictionary<string, Dictionary<string, string>> GenerateRoomByDateTime(List<ShowtimeViewModel> showtimes)
        {
            if (showtimes == null)
        ...
        //}
        public static string ConvertShowtimesToJson(List<ShowtimeViewModel> showtimes)
        {
            if (showtimes == null)
                return "[]";
            var simplified = (showtimes ?? new List<ShowtimeViewModel>())
            .Where(s => s != null)
            .Select(s => new
            {
        ...
        public static List<ShowtimeViewModel> ParseShowtimesFromJson(string? json)
        {
            var showtimes = new List<ShowtimeViewModel>();
        ...
        public static async Task SaveImagesAsync(FilmViewModel film, string uploadPath, bool useGuidName = true)
        {
